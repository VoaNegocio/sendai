...
const Header = () => (
    <header className="relative bg-brand-red border-b border-red-700 shadow-sm z-50">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <img src="/sendai-logo-horizontal-semfundo.png" alt="Sendai Smart Build" className="h-10 md:h-12 w-auto brightness-0 invert" />
            ...
            <div className="hidden md:flex">
                ...
                >
                    {/* Shimmer Effect Outline (Red on White) */}
                    ...
                    <span className="relative z-20">Solicitar Orçamento</span>
                </a>
            </div>
        </div>
    </header>
